...
export default function Footer() {
  ...
  const handleSubscribe = (e) => {
    e.preventDefault();
    // Aquí irá la lógica para guardar en el CMS o enviar el correo en el futuro
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-3 mt-4">
            {/* Facebook */}
            <a href="https://www.facebook.com/NuestraEsperanzaBo/?locale=es_LA" target="_blank" rel="noopener noreferrer" className="bg-white text-fundacion-blue p-2 rounded-full hover:bg-fundacion-pink hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
              </svg>
            </a>
            {/* Instagram */}
            <a href="https://www.instagram.com/fundacionnuestraesperanza/" target="_blank" rel="noopener noreferrer" className="bg-white text-fundacion-blue p-2 rounded-full hover:bg-fundacion-pink hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@fund.nuestra.esperanza" target="_blank" rel="noopener noreferrer" className="bg-white text-fundacion-blue p-2 rounded-full hover:bg-fundacion-pink hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div>
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row">
            ...
            <button 
              type="submit" 
              className="bg-fundacion-pink text-white font-bold px-4 py-2 rounded-r-md hover:bg-pink-600 transition-colors"
            >
              OK
            </button>
          </form>
